    ...
    <main class="form-signin">
        ...
        <form action="{{ route('register') }}" method="POST">
            ...
            <div class="w-50 text-md-left">
                <a href="{{ route('login') }}" class="text-muted" style="text-decoration: inherit; color: inherit">Faça login</a>
            </div>
        ...
        <p class="mt-5 mb-3 text-muted">
            <div class="container">
                <a href="https://github.com/onesg" target="_blank" style="text-decoration: inherit; color: inherit;"
                    data-toggle="tooltip" data-placement="top" title="Não clique em mim >:)">
